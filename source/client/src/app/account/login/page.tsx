...
import { passwordSchema } from "@/app/_user-cases/schemas";
...
export default function Login() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-start py-[150px] relative">
        ...
        <div className="w-[300px] mx-auto">
          ...
          <div
            className={`flex flex-col gap-5 ${isLoginEmail ? "hidden" : ""}`}
          >
            <AuthButton
